...
df = pd.read_csv("C:/Users/prana/Downloads/Emotion-based-music-recommendation-system-main/Emotion-based-music-recommendation-system-main/muse_v3.csv")
...
model.load_weights('C:/Users/prana/Downloads/Emotion-based-music-recommendation-system-main/Emotion-based-music-recommendation-system-main/model.h5')
...
face = cv2.CascadeClassifier('C:/Users/prana/Downloads/Emotion-based-music-recommendation-system-main/Emotion-based-music-recommendation-system-main/haarcascade_frontalface_default.xml')
if face.empty():
